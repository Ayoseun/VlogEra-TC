...
import Player2 from './play'

const style = {
  wrapper: `flex p-3 border-b border-[#38444d] h-[full]`,
  profileImage: `rounded-full h-[40px] w-[40px] object-cover mx-8`,
  postMain: `flex-4 px-4`,
  headerDetails: `flex items-center ml-4 mb-4`,
  name: `font-bold mr-1`,
